...
FILE_PLANE0_LSB = "../roms/n8-07.bin"
FILE_PLANE1_MSB = "../roms/r8-08.bin"

# Nome del file C di output
OUTPUT_C_FILE = "../../source/src/machines/mrdo/mrdo_bg_tiles.h"
C_ARRAY_NAME = "mrdo_bg_tiles"

# --- OPZIONI ---
# Imposta queste opzioni come preferisci per il background
ROTATE_TILES = True
FLIP_HORIZONTAL = True
GENERATE_PREVIEW = True
OUTPUT_PNG_FILE = "mrdo_bg_tiles_preview.png"

# Parametri (rimangono identici)
NUM_TILES = 512
TILE_WIDTH = 8
TILE_HEIGHT = 8
...
def convert_tiles():
    ...
    for tile_idx in range(NUM_TILES):
        ...
        for y in range(TILE_HEIGHT):
            row_data = []
            byte_p0 = plane0_data[base_offset + y]
            byte_p1 = plane1_data[base_offset + y]
            for x in range(TILE_WIDTH):
                bit_shift = 7 - x
